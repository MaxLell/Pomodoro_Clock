...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, GPIO_OutputD9_Pin|GPIO_OutputD5_Pin|GPIO_OutputD6_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : PCPin PCPin */
  GPIO_InitStruct.Pin = TRIGGER_BTN_Pin|ENCODER_BTN_Pin;
  ...
  GPIO_InitStruct.Pin = EXTI2_Pin|EXTI10_Pin;
  ...
  GPIO_InitStruct.Pin = GPIO_OutputD9_Pin|GPIO_OutputD5_Pin|GPIO_OutputD6_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
