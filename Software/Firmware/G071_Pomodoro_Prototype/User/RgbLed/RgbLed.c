...
#define PWM_DATA_SIZE (BIT_WIDTH_RGB_LED * RGB_LED_TOTAL_LEDS) + NUMBER_OF_OFF_PULSES_BETWEEN_LED_PULSES
...
uint8_t u8LedData[RGB_LED_TOTAL_LEDS][4]; // This stores the u32Color data values of the LEDs
