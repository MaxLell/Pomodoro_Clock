...
} LightEffects_RingCountdownEffect_e;

typedef struct
{
    u16 u16PeriodPerIncrementMsec;
    u8 u8CurrentFillingMin;
    LightEffects_RingCountdownEffect_e eEffect; // Snooze / Warning / CancelSeq
    bool bIsComplete;
} LightEffects_RingCountdown_s;
