...
static const char* CMockString_Button_Hardware_Interrupt = "Button_Hardware_Interrupt";
...
typedef struct _CMOCK_Button_Hardware_Interrupt_CALL_INSTANCE
{
  UNITY_LINE_TYPE LineNumber;
  int CallOrder;

} CMOCK_Button_Hardware_Interrupt_CALL_INSTANCE;
...
static struct mock_Button_HardwareInstance
{
  ...
  char Button_Hardware_Interrupt_IgnoreBool;
  char Button_Hardware_Interrupt_CallbackBool;
  CMOCK_Button_Hardware_Interrupt_CALLBACK Button_Hardware_Interrupt_CallbackFunctionPointer;
  int Button_Hardware_Interrupt_CallbackCalls;
  CMOCK_MEM_INDEX_TYPE Button_Hardware_Interrupt_CallInstance;
} Mock;
...
void mock_Button_Hardware_Verify(void)
{
  ...
  call_instance = Mock.Button_Hardware_Interrupt_CallInstance;
  if (Mock.Button_Hardware_Interrupt_IgnoreBool)
    call_instance = CMOCK_GUTS_NONE;
  if (CMOCK_GUTS_NONE != call_instance)
  {
    UNITY_SET_DETAIL(CMockString_Button_Hardware_Interrupt);
    UNITY_TEST_FAIL(cmock_line, CMockStringCalledLess);
  }
  if (Mock.Button_Hardware_Interrupt_CallbackFunctionPointer != NULL)
  {
    call_instance = CMOCK_GUTS_NONE;
    (void)call_instance;
  }
...
void Button_Hardware_Interrupt(void)
{
  UNITY_LINE_TYPE cmock_line = TEST_LINE_NUM;
  CMOCK_Button_Hardware_Interrupt_CALL_INSTANCE* cmock_call_instance;
  UNITY_SET_DETAIL(CMockString_Button_Hardware_Interrupt);
  cmock_call_instance = (CMOCK_Button_Hardware_Interrupt_CALL_INSTANCE*)CMock_Guts_GetAddressFor(Mock.Button_Hardware_Interrupt_CallInstance);
  Mock.Button_Hardware_Interrupt_CallInstance = CMock_Guts_MemNext(Mock.Button_Hardware_Interrupt_CallInstance);
  if (Mock.Button_Hardware_Interrupt_IgnoreBool)
  {
    UNITY_CLR_DETAILS();
    return;
  }
  if (!Mock.Button_Hardware_Interrupt_CallbackBool &&
      Mock.Button_Hardware_Interrupt_CallbackFunctionPointer != NULL)
  {
    Mock.Button_Hardware_Interrupt_CallbackFunctionPointer(Mock.Button_Hardware_Interrupt_CallbackCalls++);
    UNITY_CLR_DETAILS();
    return;
  }
  UNITY_TEST_ASSERT_NOT_NULL(cmock_call_instance, cmock_line, CMockStringCalledMore);
...
{
  Mock.Button_Hardware_Interrupt_IgnoreBool = (char)1;
}

void Button_Hardware_Interrupt_CMockStopIgnore(void)
{
  Mock.Button_Hardware_Interrupt_IgnoreBool = (char)0;
}

void Button_Hardware_Interrupt_CMockExpect(UNITY_LINE_TYPE cmock_line)
{
  CMOCK_MEM_INDEX_TYPE cmock_guts_index = CMock_Guts_MemNew(sizeof(CMOCK_Button_Hardware_Interrupt_CALL_INSTANCE));
  CMOCK_Button_Hardware_Interrupt_CALL_INSTANCE* cmock_call_instance = (CMOCK_Button_Hardware_Interrupt_CALL_INSTANCE*)CMock_Guts_GetAddressFor(cmock_guts_index);
  UNITY_TEST_ASSERT_NOT_NULL(cmock_call_instance, cmock_line, CMockStringOutOfMemory);
  memset(cmock_call_instance, 0, sizeof(*cmock_call_instance));
  Mock.Button_Hardware_Interrupt_CallInstance = CMock_Guts_MemChain(Mock.Button_Hardware_Interrupt_CallInstance, cmock_guts_index);
  Mock.Button_Hardware_Interrupt_IgnoreBool = (char)0;
  cmock_call_instance->LineNumber = cmock_line;
  cmock_call_instance->CallOrder = ++GlobalExpectCount;
}
...
{
  Mock.Button_Hardware_Interrupt_IgnoreBool = (char)0;
  Mock.Button_Hardware_Interrupt_CallbackBool = (char)1;
  Mock.Button_Hardware_Interrupt_CallbackFunctionPointer = Callback;
}

void Button_Hardware_Interrupt_Stub(CMOCK_Button_Hardware_Interrupt_CALLBACK Callback)
{
  Mock.Button_Hardware_Interrupt_IgnoreBool = (char)0;
  Mock.Button_Hardware_Interrupt_CallbackBool = (char)0;
  Mock.Button_Hardware_Interrupt_CallbackFunctionPointer = Callback;
}
